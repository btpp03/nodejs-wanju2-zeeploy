...
export NEZHA_KEY=${NEZHA_KEY:-'v4ceLeQfPNRHstWauQ'}   # v1进后台复制安装命令中的NZ_CLIENT_SECRET值
...
export SUB_NAME=${SUB_NAME:-'weirdhost'} # 节点名称，配合哪吒面板v1可以自动设置面板名称
...
# 新增：使用 ps 和 grep 查找进程，替代 pgrep
PROCESS_NAME="your_process_name"  # 请替换为实际的进程名称
